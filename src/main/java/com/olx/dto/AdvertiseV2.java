...
@ApiModel(value = "Advertise Model Version 2")
public class AdvertiseV2 {
    ...
    public AdvertiseV2(int id, String title, double price, int categoryId, String description, String username, LocalDate createdDate, LocalDate modifiedDate, int statusId) {
        this.id = id;
        this.title = title;
        this.price = price;
    ...
    public AdvertiseV2(int id, String title, double price, int categoryId, Category category, String description, String username, LocalDate createdDate, LocalDate modifiedDate, int statusId, Status status) {
        this.id = id;
        this.title = title;
        this.price = price;
        this.categoryId = categoryId;
